...
export async function GET() {
  ...
  return new NextResponse("Certificate ID is missing.", { status: 500 });
}
  ...
  const pdfStream = await renderToStream(
    <CertificatePdf
     ...
     logoUrl="/logo/g4ep.png"
signatureOneUrl="/signatures/g4ep-signature-1.png"
signatureTwoUrl="/signatures/g4ep-signature-2.png"
sealUrl="/seals/g4ep-seal.png"
    />
  );
