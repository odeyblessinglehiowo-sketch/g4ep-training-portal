    ...
    <main className="space-y-6">
      <section className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Approve or reject student submissions and leave feedback for corrections.
        </p>
      </section>
            ...
            >
              ...
              {submission.remark && (
                <div className="mt-4 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
                  <p className="text-sm font-semibold text-slate-800">Current Remark</p>
                  <p className="mt-2 text-sm text-slate-600">{submission.remark}</p>
                </div>
              )}

              <div className="mt-6 grid gap-4 lg:grid-cols-2">
                <form action={updateSubmissionStatus} className="space-y-3 rounded-2xl border border-green-200 bg-green-50 p-4">
                  ...
                  <textarea
                    ...
                    defaultValue={submission.status === "APPROVED" ? submission.remark ?? "" : ""}
                ...
                <form action={updateSubmissionStatus} className="space-y-3 rounded-2xl border border-red-200 bg-red-50 p-4">
                  <input type="hidden" name="submissionId" value={submission.id} />
                  ...
                  <textarea
                    ...
                    defaultValue={submission.status === "REJECTED" ? submission.remark ?? "" : ""}
